...
type VmConfig =
    { Name : ResourceName
      ...
      IpAllocation: AllocationMethod option
...
/// You have to set the Username to make a valid VM config.
type VmInitialConfig = | Preconfig of VmConfig
...
type VirtualMachineBuilder() =
    ...
    member __.Name(Preconfig state, name) = Preconfig { state with Name = name }
    member this.Name(Preconfig state, name) = Preconfig { state with Name = ResourceName name }
    ...
    member __.Username(Preconfig config, username) = { config with Username = Some username }
    ...
    member _.IpAllocation(state: VmConfig, ref: AllocationMethod Option) = { state with IpAllocation = ref}
    member _.IpAllocation(state: VmConfig, ref: AllocationMethod) = { state with IpAllocation = Some ref}
