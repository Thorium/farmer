...
type VirtualMachineBuilder() =
    ...
    member __.Name(state:VmNameUsernameConfig, name) = { state with Name = name }
    member this.Name(state:VmNameUsernameConfig, name) = this.Name(state, ResourceName name)
    ...
    member __.Username(state:VmNameUsernameConfig, username) = 
        { Name = state.Name
